...
| A new faction gift ([tables](characters/traits.md#the-factions-gifts--flaws)) — you built the capability | **4** |
| Found a new [holding](faction/nodes.md) — your personal project becomes a chapter | **5** |
| +1 to a faction stat (max 5) — players may pool perks | **8** |

Faction advances are cheaper than personal ones on purpose. Whatever a player builds for the faction, put their name on it in the narrative — *Brakk's strike team*, *Halla's priory*. The organization remembers its builders, and so should the story.
...
- **Again** — one extra use of a limited feature per conflict or session (whichever limits it).
- **Wider** — the feature reaches one more target, one more range band, or a group instead of a person.
- **Sharper** — the feature's edge becomes two edges, or its effect steps up (1 strain cleared becomes 2; a condition downgraded becomes removed).
