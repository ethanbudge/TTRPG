...
Planning doesn't drag: the crew states the shape of the job and banks what preparation it can. Coyle stakes 2 stock as a **War Chest** — Ready for anyone on the job. Rook calls a **War Council** over the blueprints and wins the roll: three of them take primed edges in. Delle has spent two weeks as the bank's favorite new client, which is established groundwork, not a roll.
...
<p><span class="speaker">GM:</span> "Vault rolls… 18. Tie. You're acting: the lock chirps, believes you, and swings. The cost — as the bolts retract, the sound wakes the one thing your recon never found: a silent seismic sensor under the floor plate. Somewhere across town, a phone is ringing. You have minutes. We're in <a href='#/combat/overview'>conflict</a>, clockspeed Blitz, and I'm starting two countdowns: <em>The Take (4)</em> and <em>Response Arrives (4)</em>."</p>
</div>
...
<p><span class="speaker">Grace:</span> "Goal: the courier truck leaves an empty bay on every screen on the block." <em>4 dice against 3: 11–13.</em> <strong>Loss.</strong></p>
<p><span class="speaker">GM:</span> "The truck gets out — but one traffic camera two blocks east catches the plate, and you know it. That's not tonight's problem. That's a countdown on the faction sheet: <em>The Plate Comes Back (6)</em>."</p>
</div>
